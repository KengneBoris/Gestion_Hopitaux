...
<html>
  ...
  <body>
        <div class="content-inner w-100">
                ...
                <div class="col-lg-12">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">liste des personnels</h3>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table mb-0 table table-bordered">
                          ...
                          <button type="submit"  style="margin-left :850px"  class="btn btn-success"> 
                    ...
                    ajouter</button><br><br>
                          ...
                          <tbody>
                         <?php
                             $reponse=$bdd->query("SELECT *from user where TYPE='medecin'");
                          $i=0;
                         while($rep=$reponse->fetch()){
                            ...
                            <td>".$rep[5]."</td>
                            <td>".$rep[6]."</td>
                            <td><center><a  class='btn btn-danger waves-effect waves-light m-r-10' href='fonction.php?id=$rep[0]' > <i class='fa fa-trash'></i> supprimer </a></center></td>
                            <td><center><a data-bs-toggle='modal' data-bs-target='#myModal_$i'  class='btn btn-info waves-effect waves-light m-r-10' href='#'><i class='fa fa-edit'></i> modifier </a></center></td>
          ...
          <?php
     $reponse1=$bdd->query("SELECT *from user where TYPE='medecin'");
          $i=0;
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="myModalLabel">Update administrateur</h5>
