...
<html>
  ...
  <body>
        <div class="content-inner w-100">
                ...
                <div class="col-lg-12">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">liste des administrateurs</h3>
                    ...
                    ajouter</button><br><br>
                          ...
                          <tbody>
                         <?php
                             $reponse=$bdd->query("SELECT *from user where type='administrateur'");
                          $i=0;
          ...
          <?php
     $reponse1=$bdd->query("SELECT *from user where type='administrateur'");
          $i=0;
