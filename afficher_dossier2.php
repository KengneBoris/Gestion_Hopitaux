  ...
  <body>
        ...
        <div style="margin-top: 30px;"><p>Le present dossier appartient à : </p></div> 
          <div style="margin-top: 70px; margin-left: 200px">
            ...
            <div style="margin-top: -240px; margin-left: 200px">
          ...
          <div style="margin-top: -165px; margin-left: 500px; margin-bottom: 100px">
            <div>
            <img style="border-width: 3px;border-style: dotted; width: 350px; height: 250px; margin-top: -80px; margin-left: 200px" src="<?= $req_user['photo'] ?>" alt="">
            </div>
          </div>
          <div>
          <?php
                                            
                                            $menu1=$bdd->query("SELECT * from concultation c, patient p, dossier_patient d where p.ID_PATIENT=c.ID_PATIENT and p.ID_PATIENT=d.ID_PATIENT and p.ID_PATIENT=$personName");
          ...
          <a href="print_dossier2.php?matricule=<?=$personName?>">
                          <button type="submit"  style="margin-left :850px"  class="btn btn-danger"> 
                    <i class="fas fa-plus"></i>
                    imprimer</button><br><br>
                            </a>
