                ...
                <div class="col-lg-12">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">liste des concultations</h3>
                    ...
                    ajouter</button><br><br>
                          ...
                          <tbody>
                         <?php
                             $reponse=$bdd->query("SELECT ID_CONSULTATION,nom,INFORMATION,DATE from concultation c ,patient p WHERE c.ID_PATIENT=p.ID_PATIENT");
                          $i=0;
                         while($rep=$reponse->fetch()){
                            echo"
                            <tr>
                            <td>".decrypter($rep[1])."</td>
                            <td>".decrypter($rep[2])."</td>
                            <td>".$rep[3]."</td>                           
                            <td><center><a  class='btn btn-danger waves-effect waves-light m-r-10' href='supprimer_concultation.php?id_concultation=$rep[0]' > <i class='fas fa-trash-alt'></i>Supprimer</a></center></td>                                                        
                            </tr>
                            ";
                            $i++;
                         }
