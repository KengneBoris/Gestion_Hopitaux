...
<head>
  ...
  <body>
         ...
         ?>
          ...
          ?>
                <!-- new section -->
          <form action="ajout_dossier.php" method="post"  enctype="multipart/form-data">
          <section class="forms"> 
            <div class="container-fluid">
                ...
                <!-- Basic Form-->
                        ...
                        <div class="card">
                            ...
                            <h3 class="h4 mb-0">Creation Dossier</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="exampleInput1">Nom Dossier :</label>
                                    <input class="form-control" type="text" name="nom" required value="PATIENT" id="" cols="30" rows="10">
                                </div>
                                ...
                                <div class="mb-3">
                                <label class="form-label" for="exampleInp">nom Medecin :</label><select  name="id_personnel" id="" class="form-control">
                                <?php
                                            
                                            $menu1=$bdd->query("SELECT *from user where TYPE = 'medecin'");
                                            while($rep1=$menu1->fetch()){?>
                                             <option value="<?php echo $rep1['ID_USER'] ?>"><?php echo $rep1['NOM'] ?></option>
